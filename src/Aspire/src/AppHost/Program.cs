...
var persistMessageFlightDb = postgres.AddDatabase("persist-message-flight");
var persistMessagePassengerDb = postgres.AddDatabase("persist-message-passenger");
var persistMessageIdentityDb = postgres.AddDatabase("persist-message-identity");
var persistMessageBookingDb = postgres.AddDatabase("persist-message-booking");
...
var api = builder
    .AddProject<Api>("api")
    .WithReference(persistMessageFlightDb)
    .WaitFor(persistMessageFlightDb)
    .WithReference(persistMessagePassengerDb)
    .WaitFor(persistMessagePassengerDb)
    .WithReference(persistMessageIdentityDb)
    .WaitFor(persistMessageIdentityDb)
    .WithReference(persistMessageBookingDb)
    .WaitFor(persistMessageBookingDb)
