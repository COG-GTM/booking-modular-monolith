...
// Deprecated: monolith API host (kept for transition period)
var api = builder
    .AddProject<Api>("api")
...
var flightApi = builder
    ...
    .WithHttpEndpoint(port: 5010, name: "flight-http")
    .WithHttpsEndpoint(port: 5011, name: "flight-https");
...
var passengerApi = builder
    ...
    .WaitFor(rabbitmq)
    .WithReference(identityApi)
    .WithHttpEndpoint(port: 5020, name: "passenger-http")
    .WithHttpsEndpoint(port: 5021, name: "passenger-https");
...
var bookingApi = builder
    ...
    .WithReference(identityApi)
    .WithHttpEndpoint(port: 5030, name: "booking-http")
    .WithHttpsEndpoint(port: 5031, name: "booking-https");
...
var gateway = builder
    ...
    .WithReference(identityApi)
    .WithHttpEndpoint(port: 5050, name: "gateway-http")
    .WithHttpsEndpoint(port: 5051, name: "gateway-https");
