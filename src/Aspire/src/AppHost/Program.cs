...
// Per-module service hosts (microservices topology)
var identityApi = builder
    ...
    .WithHttpsEndpoint(port: 5051, name: "identity-https");
...
var flightApi = builder
    ...
    .WithReference(rabbitmq)
    .WaitFor(rabbitmq)
    .WithHttpEndpoint(port: 5002, name: "flight-http")
    .WithHttpsEndpoint(port: 5052, name: "flight-https");
...
var passengerApi = builder
    ...
    .WithHttpsEndpoint(port: 5053, name: "passenger-https");
...
var bookingApi = builder
    ...
    .WithHttpsEndpoint(port: 5054, name: "booking-https");
