...
public static class SharedInfrastructureExtensions
{
    public static WebApplicationBuilder AddSharedInfrastructure(this WebApplicationBuilder builder)
    {
        ...
        var transportType = builder.Configuration.GetValue("Messaging:TransportType", TransportType.InMemory);
    ...
    public static WebApplicationBuilder AddModuleEventMapper<TEventMapper>(this WebApplicationBuilder builder)
        where TEventMapper : class, IEventMapper
    {
        builder.Services.AddScoped<IEventMapper>(sp => new CompositeEventMapper(
            new IEventMapper[] { sp.GetRequiredService<TEventMapper>() }
        ));
