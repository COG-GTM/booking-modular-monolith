...
public class PassengerPersistMessageDbContext : PersistMessageDbContext
{
    public PassengerPersistMessageDbContext(
        DbContextOptions<PassengerPersistMessageDbContext> options,
