...
public class IdentityPersistMessageDbContext : PersistMessageDbContext
{
    public IdentityPersistMessageDbContext(
        DbContextOptions<IdentityPersistMessageDbContext> options,
